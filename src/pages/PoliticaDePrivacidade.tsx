...
import { Home, ChevronRight, ShieldCheck, FileText, Lock, Clock } from "lucide-react";
...
const PoliticaDePrivacidade = () => {
  ...
  const { headings, effectiveDate } = useMemo(() => {
    ...
    const dateMatch = politicaDePrivacidadeMarkdown.match(
  ...
  return (
    <>
      <SEO
        title="Política de Privacidade – Meu Agente"
        description="Entenda em detalhes como o Meu Agente coleta, utiliza, armazena e protege seus dados pessoais, em conformidade com a LGPD."
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative overflow-hidden border-b border-border/50 bg-gradient-to-br from-surface via-background to-surface py-14 sm:py-16">
          ...
          <div className="pointer-events-none absolute inset-0 opacity-40 mix-blend-screen">
            <div className="bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.20),_transparent_60%)]" />
          </div>
            ...
            <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,2.2fr)_minmax(0,1.2fr)]">
              <div className="space-y-6">
                ...
                <p className="max-w-2xl text-balance text-base text-text-muted sm:text-lg">
                  Esta Política explica, em linguagem acessível, como tratamos
                  seus dados pessoais na Plataforma Meu Agente – da coleta ao
                  armazenamento, incluindo direitos do titular e medidas de
                  segurança adotadas.
                </p>
                ...
                <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm text-text-muted">
                  <div className="inline-flex items-center gap-2 rounded-full border border-border/60 bg-surface/80 px-3 py-1">
                    ...
                    <span>Conformidade com LGPD e boas práticas de segurança</span>
                  </div>
                  <div className="inline-flex items-center gap-2 rounded-full border border-border/60 bg-surface/80 px-3 py-1">
              ...
              <Card className="border-border/70 bg-background/90 shadow-2xl-adaptive backdrop-blur">
                ...
                <CardContent className="space-y-3 text-sm text-text-muted">
                  <p>
                    Ao utilizar a Plataforma Meu Agente, você declara que leu,
                    compreendeu e concorda com esta Política de Privacidade e
                    com os Termos de Uso.
                  </p>
                  <p>
                    Se tiver qualquer dúvida sobre o tratamento dos seus dados,
                    entre em contato com nosso canal de privacidade indicado ao
                    final deste documento.
                  </p>
                  <Separator className="my-3" />
                  <p className="text-xs">
                    Esta seção é apenas um resumo. A versão legalmente válida é
                    o conteúdo completo apresentado abaixo.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="mb-6 flex items-baseline justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-text-muted">
                  Leia com atenção cada seção. Recomendamos consultar esta
                  página sempre que tiver dúvidas sobre privacidade ou LGPD.
                </p>
              </div>
            </div>
                  ...
                  <Card className="border-border/70 bg-surface/90">
                    ...
                    <CardContent className="space-y-2 text-sm text-text-muted">
                      <p>
                        ...
                        correção, exclusão, revogação de consentimento etc.),
                        envie um e-mail para{" "}
                        <span className="font-semibold text-text">
                          privacidade@meuagente.api.br
                        </span>
                        .
                      </p>
                      <p className="text-xs">
                        Nosso time de privacidade (DPO) irá analisar sua
                        solicitação e responder dentro dos prazos previstos na
                        LGPD.
                      </p>
                    </CardContent>
                  </Card>
