      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {integrations.map((integration, index) => (
            <Card
              key={index}
              className={`group relative overflow-hidden p-8 bg-gradient-to-br ${integration.color} border-border/50 hover:border-accent transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-xl-adaptive animate-fade-in`}
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-text-muted max-w-3xl mx-auto">
            ...
            <span className="text-accent font-semibold">Business</span> e{" "}
            <span className="text-accent font-semibold">Premium</span> mediante implantação opcional com custo adicional. Todas as integrações seguem as melhores práticas de segurança e requerem OAuth com escopos mínimos.
          </p>
        </div>
      </div>
    </section>
